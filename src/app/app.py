...
features_map = {
    ...
    "PERCENTUAL RACA NAO-BRANCA": "txCorRacaNaoBranca",
...
Altere as opções dos botões abaixo para ver as mudanças no gráfico.    
"""
...
with col2:
    if cluster:
        features_options_selected = st.multiselect(label="Variáveis para agrupamento", options=features_options, default=["PERCENTUAL FEMININO", "PERCENTUAL RACA PRETA"])
...
st.markdown("""
### Créditos
Você pode conferir o repositório deste projeto aqui: 
            """)